        ...
        <div class="wraper">
            ...
            <form class="login100-form validate-form" action='editopunonjesquery.php?edit=<?php echo $_GET['edit'] ?>' method='post'>
                ...
                <span class="login100-form-title">
                 <h2> <?php echo  $row['Emer']; ?>  <?php echo  $row['Mbiemer']; ?></h2> 
                </span>

                <div class="wrap-input100 validate-input" data-validate="Username">
                    <input class="input100" type="username" name="username" value="<?php echo  $row['Username']; ?>">
                    ...
                    <div class="box">
                        <select class="form-control" name="Roli">
                            <option selected="true" disabled="disabled" value="<?php echo  $row['Roli']; ?>">Roli </option>                 
